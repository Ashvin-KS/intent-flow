...
#[tauri::command]
pub async fn get_recent_files(limit: Option<usize>) -> Result<Vec<String>, String> {
    Ok(crate::utils::windows::get_recent_files(limit.unwrap_or(10)))
}
...
pub async fn get_clipboard_history(
    ...
    crate::database::queries::get_clipboard_history(&conn, limit.unwrap_or(10))
        .map_err(|e| e.to_string())
}
